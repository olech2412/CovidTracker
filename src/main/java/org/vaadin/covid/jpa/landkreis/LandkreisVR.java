...
public class LandkreisVR {
    ...
    public LandkreisVR(Double casesPerPopulation, Double cases7per100k, Integer cases7, Double casesPer100k, Integer death7, Integer cases, LocalDate creationDate) {
