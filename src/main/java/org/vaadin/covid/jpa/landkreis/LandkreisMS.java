...
public class LandkreisMS {
    ...
    public LandkreisMS(Double casesPerPopulation, Double cases7per100k, Integer cases7, Double casesPer100k, Integer death7, Integer cases, LocalDate creationDate) {
