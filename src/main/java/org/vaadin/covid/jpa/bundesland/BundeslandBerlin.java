...
public class BundeslandBerlin {
    ...
    public BundeslandBerlin(Double cases7per100k, Integer cases7, Double cases100k, Integer death, Integer death7, Integer cases, LocalDateTime lastUpdate, LocalDate creationDate) {
